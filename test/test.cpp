...
int main(int argc, const char* argv[])
{
    ...
    if(argc < 3){
        ...
        //RE_RUN_REG("rtsp_example", argc, argv);
        //RE_RUN_REG("rtsp_client_test", "127.0.0.1:8557", "live");
        //rtsp_client_test("10.55.4.15", "live");
        rtsp_client_test("10.55.0.105", "live");
        //rtsp_client_test("127.0.0.1", "live");
        goto EXIT;
    }
